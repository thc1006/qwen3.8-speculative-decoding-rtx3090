...
| **Previous tag** | signed tag `v1.0.2`, commit `8d301e8d64...`. Tagged as the intended deposit and superseded before one was made: 13 numbered corrections were appended after it, 45 through 57, and Correction 57 withdrew the negative rejection-cost claim from Phase A and Phase KV, so depositing that tree would have archived a reading this study no longer makes. |
