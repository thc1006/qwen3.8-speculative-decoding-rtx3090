...
|---|---|---|---|---|
| **A** (complete: 875 records) | headline effects with intervals, at verified stock | 7 | 5 | ~2.3 h |
...
second target quant. That became **Phase Q**, not Phase R2 -- the name R2 went to the SM-clock-pinning
re-run instead. Phase Q ran the two rungs a 24 GB card holds; `UD-Q6_K_XL` at 27.5 GB and `Q8_0`
at 31.3 GB are blocked on VRAM rather than on disk, and remain unrun.
